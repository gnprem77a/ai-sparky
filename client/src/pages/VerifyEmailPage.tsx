            ...
            <div className="space-y-4">
              <div className="relative">
                ...
                <input
                  ...
                  maxLength={30}
                  autoFocus
                  className="w-full pl-9 pr-3.5 py-2.5 rounded-xl text-sm bg-background border border-border hover:border-border/80 focus:border-primary/60 focus:ring-2 focus:ring-primary/30 transition-colors outline-none placeholder:text-muted-foreground/50 text-foreground"
                />
              </div>
